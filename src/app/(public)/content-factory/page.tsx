...
export default function ContentFactoryPage() {
  return (
    <div className="text-content leading-snug mb-10">
      ...
      />
      <section className="py-6 md:py-8 lg:py-16 max-w-4xl mx-auto text-center">
      ...
      <section className="lg:py-12 py-6">
        ...
        <p className="lg:text-3xl sm:text-2xl text-xl font-nunito-sans leading-normal">
      ...
      <section className="lg:pt-12 pt-6">
        <h2 className="mb-6 text-accent">
          From Concept to Getting Impressions
        </h2>
        <p className="lg:text-3xl sm:text-2xl text-xl font-nunito-sans leading-normal mb-4">
        ...
        <div className="lg:py-6 py-4">
          ...
          <ul className="custom-list lg:text-3xl sm:text-2xl text-xl">
