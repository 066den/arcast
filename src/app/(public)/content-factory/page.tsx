  ...
  return (
    <div className="text-content leading-snug mb-10">
      ...
      <section className="lg:py-12 py-6">
        ...
        <p className="lg:text-3xl text-2xl font-nunito-sans leading-normal">
      ...
      <section className="lg:pt-12 pt-6">
        ...
        <p className="lg:text-3xl text-2xl font-nunito-sans leading-normal mb-4">
        ...
        <div className="lg:py-6 py-4">
          ...
          <ul className="custom-list lg:text-3xl text-2xl">
